...
namespace LotteryData
{
    public partial class SQLiteHelper
    {
        ...
        public static int ExecuteNonQuery(string connectionString, string commandText, params SQLiteParameter[] paramList)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                using (SQLiteCommand cmd = new SQLiteCommand())
                {
                    try
                    {
                        PrepareCommand(cmd, connection, CommandType.Text, commandText, paramList);
            ...
            foreach (object o in paramList)
            {
                ...
                switch (t.ToString())
                {
                    ...
                    case ("System.Object"):
                        ...
                        coll.Add(parm);
                        break;
                    //case ("{Name = \"SqlParameter\" FullName = \"System.Data.SqlClient.SqlParameter\"}"):
                    //    parm.DbType= paramList.
